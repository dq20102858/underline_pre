<template>
  <div id="monitor">
    <div class="el-menu-top">
      <el-menu router default-active="bridge" mode="horizontal">
        <li class="ptitle">
        ...
        <el-menu-item index="alerts">过渡段设置</el-menu-item>
      ...
      <div class="app-page-container">
        ...
        <div class="app-table">
          <el-table :data="dataList">
            ...
            <el-table-column prop="position" label="结束里程">
              <template slot-scope="scope">
                <b>DK</b>
...
export default {
  ...
  methods: {
    getDataList() {
      ...
      let road_type = 1; //1桥，2隧道，3坡度，4防区，5限速
      this.request({
