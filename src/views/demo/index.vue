        ...
        <div>
          <el-form :inline="true" :model="hkvInfo" class="demo-form-inline">
            ...
            <el-row>
              <el-col>
                <el-form-item>
                  <el-button type="primary" :loading="loginLoading" @click="clickLogin">登录</el-button>
                  <el-button
                    type="primary"
...
<script>
import { WebVideoCtrl } from "../../plugins/webVideoCtrl.js";

export default {
  data() {
    return {
      hkvInfo: {
        ip: "192.168.5.2", //海康威视摄像头/硬盘录像机的ip地址
