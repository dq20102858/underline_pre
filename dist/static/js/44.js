...
/* harmony default export */ var cardetector = ({
  ...
  methods: {
    ...
    goEdit: function goEdit(id) {
      ...
      this.diaLogFormVisible = true;
      this.$nextTick(function () {
        _this6.$refs["detectorRulesForm"].clearValidate();
      });
      this.request({
        ...
        if (data.status == 1) {
          ...
          _this6.getTrainList(data.data.depart_id);
        }
      });
    },
...
// load the styles
var content = __webpack_require__("B8ow");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("360e4b17", content, true);
