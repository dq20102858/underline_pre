...
// load the styles
var content = __webpack_require__("idwv");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("0946af2e", content, true);
      ...
      this.$refs["formRules"].validate(function (valid) {
        if (valid) {
          ...
          if (parseInt(pnum) < parseInt(lineStart)) {
            _this4.$message({
              message: "位置输入不在线别" + lineStart + "~" + lineEnd + "里程范围内",
              duration: 5000,
              type: "error"
            });
        ...
        if (data.status == 1) {
          ...
          _this5.lineTypeList.map(function (item, index) {
            if (item.id == data.data.line_type) {
              ...
              _this5.formData.position = parseFloat(data.data.position);
            }
          });
        }
      });
