...
// load the styles
var content = __webpack_require__("ELWU");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("0285e2c6", content, true);
    ...
    initCanvas: function initCanvas() {
        ...
        img.onload = function () {
          ...
          for (var _i2 = 0; _i2 < json.length; _i2++) {
            ...
            if (total == leftLineMaxMileage) {
              ...
              context.fillStyle = "#fff";
              context.textAlign = "left";
              var _origin = json[_i2].name;
              var _lens = json[_i2].name.length;
              context.fillText(_origin, startX + 90, 25);
              //DK
              var _codes = "DK" + json[_i2].start_flag + " +" + json[_i2].start_length;
              context.fillStyle = "#0AE39A";
              context.font = "14px Microsoft Yahei";
              context.fillText(_codes, startX + 90, 52);
            }
          }
        };
      }
      ...
      function drawDaocha() {
        ...
        var _loop = function _loop(_i3) {
          var start = parseInt(json[_i3].start_flag) * 1000 + parseInt(json[_i3].start_length);
          var end = parseInt(json[_i3].end_flag) * 1000 + parseInt(json[_i3].end_length);
          var betweenMeters = (end - start) * everys; //两点之间距离米
          var startX = (start - leftLineMinMileage) * everys;
          var img = new Image();
          img.src = __webpack_require__("R6x/")("./icon-dc" + _i3 + ".png");
          img.onload = function () {
      ...
      function drawDaochas() {
        ...
        for (var _i4 = 0; _i4 < json.length; _i4++) {
          var _start = parseInt(json[_i4].start_flag) * 1000 + parseInt(json[_i4].start_length);
          var _end = parseInt(json[_i4].end_flag) * 1000 + parseInt(json[_i4].end_length);
          ...
          var _startX = (_start - leftLineMinMileage) * everys;
          var endX = (_end - leftLineMinMileage) * everys;
          if (json[_i4].type == 1) {
            context.moveTo(_startX + offsetX, 30);
            context.lineTo(endX + offsetX, 30);
            context.moveTo(_startX + offsetX, 60);
            context.lineTo(endX + offsetX, 60);
            context.moveTo(_startX + offsetX + 5, 30);
            context.lineTo(endX + offsetX - 5, 60);
            context.moveTo(_startX + offsetX + 5, 60);
            context.lineTo(endX + offsetX - 5, 30);
          } else if (json[_i4].type == 2) {
            context.moveTo(_startX + offsetX, 30);
            context.lineTo(endX + offsetX, 30);
            context.moveTo(_startX + offsetX, 60);
            context.lineTo(endX + offsetX, 60);
            context.moveTo(_startX + offsetX + 60, 30);
            context.lineTo(endX + offsetX + 20, 75);
            context.moveTo(_startX + offsetX + 60, 60);
            context.lineTo(endX + offsetX + 20, 15);
          } else if (json[_i4].type == 3) {
            context.moveTo(_startX + offsetX, 30);
            context.lineTo(endX + offsetX, 30);
            context.moveTo(_startX + offsetX, 60);
            context.lineTo(endX + offsetX, 60);
            context.moveTo(_startX + offsetX + 5, 60);
            context.lineTo(endX + offsetX - 5, 30);
          } else if (json[_i4].type == 4) {
            context.moveTo(_startX + offsetX, 30);
            context.lineTo(endX + offsetX, 30);
            context.moveTo(_startX + offsetX, 60);
            context.lineTo(endX + offsetX, 60);

            context.moveTo(_startX + offsetX, 10);
            context.lineTo(_startX + offsetX + 20, 30);

            context.moveTo(_startX + offsetX + 20, 60);
            context.lineTo(_startX + offsetX + 0, 85);
      ...
      function drawBridgeAxis(bridgeListJson) {
        ...
        for (var _i5 = 0; _i5 < json.length; _i5++) {
          var _start2 = parseInt(json[_i5].start_flag) * 1000 + parseInt(json[_i5].start_length);
          var _end2 = parseInt(json[_i5].end_flag) * 1000 + parseInt(json[_i5].end_length);
          var betweenMeters = _end2 - _start2; //两点之间距离米
          var _startX2 = (_start2 - leftLineMinMileage) * everys; //开始值
          ...
          if (json[_i5].line_type == 1) {
            //画垂直线
            context.fillRect(_startX2 + offsetX - 1, axis_LeftLine.y - 101, 2, 96);
            context.fillRect(endX + offsetX - 1, axis_LeftLine.y - 101, 2, 96);
            context.moveTo(_startX2 + offsetX, axis_LeftLine.y - 100);
            ...
            //画垂直线
            context.fillRect(_startX2 + offsetX - 1, axis_LeftLine_Two.y - 101, 2, 96);
            context.fillRect(endX + offsetX - 1, axis_LeftLine_Two.y - 101, 2, 96);
            context.moveTo(_startX2 + offsetX, axis_LeftLine_Two.y - 100);
      ...
      function drawTunnelAxis(tunnelListJson) {
        ...
        for (var _i6 = 0; _i6 < json.length; _i6++) {
          var _start3 = parseInt(json[_i6].start_flag) * 1000 + parseInt(json[_i6].start_length);
          var _end3 = parseInt(json[_i6].end_flag) * 1000 + parseInt(json[_i6].end_length);
          var betweenMeters = _end3 - _start3; //两点之间距离米
          var _startX3 = (_start3 - leftLineMinMileage) * everys; //开始值
          var endX = (_end3 - leftLineMinMileage) * everys; //结束值
          var centerX = (endX + _startX3) / 2; //开始结束平均值

          var desc = json[_i6].name + " 共" + betweenMeters + "米";
          var codes = "DK" + json[_i6].start_flag + " +" + json[_i6].start_length + " ~ " + "DK" + json[_i6].end_flag + " +" + json[_i6].end_length;
          ...
          if (json[_i6].line_type == 1) {
            //画垂直线  矩形
            context.fillRect(_startX3 + offsetX - 1, axis_LeftLine.y - 38, 2, 33);
            context.fillRect(endX + offsetX - 1, axis_LeftLine.y - 38, 2, 33);
            context.moveTo(_startX3 + offsetX, axis_LeftLine.y - 37);
            ...
            //画垂直线 画矩形
            context.fillRect(_startX3 + offsetX - 1, axis_LeftLine_Two.y - 38, 2, 33);
            context.fillRect(endX + offsetX - 1, axis_LeftLine_Two.y - 38, 2, 33);
            context.moveTo(_startX3 + offsetX, axis_LeftLine_Two.y - 37);
      ...
      function drawSpeedAxis(speedListJson) {
        ...
        for (var _i7 = 0; _i7 < json.length; _i7++) {
          var _start4 = parseInt(json[_i7].start_flag) * 1000 + parseInt(json[_i7].start_length);
          var _end4 = parseInt(json[_i7].end_flag) * 1000 + parseInt(json[_i7].end_length);
          context.strokeStyle = "#ff9900";
          context.lineWidth = 2;
          context.fillStyle = "#ff9900";
          context.font = "12px Microsoft Yahei";
          var desc = "限速" + json[_i7].speed + "公里/小时";
          context.beginPath();
          //画水平直线
          if (json[_i7].line_type == 1) {
            var _startX4 = (_start4 - leftLineMinMileage) * everys;
            var endX = (_end4 - leftLineMinMileage) * everys;
            var centerX = (endX + _startX4) / 2; //开始结束平均值
            context.fillRect(centerX + offsetX, axis_LeftLine.y + 7, 2, 25);
            context.moveTo(_startX4 + offsetX, axis_LeftLine.y + 7);
            ...
            var _startX5 = (_start4 - leftLineMinMileage) * everys;
            var _endX = (_end4 - leftLineMinMileage) * everys;
            var _centerX = (_endX + _startX5) / 2;
            if (_start4 == 0) {
              _startX5 = 0;
              _endX = _end4 * everys;
            }
            context.fillRect(_centerX + offsetX, axis_LeftLine_Two.y + 7, 2, 25);
            context.moveTo(_startX5 + offsetX, axis_LeftLine_Two.y + 7);
      ...
      function drawBuildAxis(listJson) {
        ...
        for (var _i8 = 0; _i8 < json.length; _i8++) {
          var _start5 = parseInt(json[_i8].start_flag) * 1000 + parseInt(json[_i8].start_length);
          var _end5 = parseInt(json[_i8].end_flag) * 1000 + parseInt(json[_i8].end_length);
          context.strokeStyle = "#08ce80";
          context.lineWidth = 2;
          context.fillStyle = "#08ce80";
          context.font = "12px Microsoft Yahei";
          var desc = json[_i8].name;
          context.beginPath();
          //画水平直线
          if (json[_i8].line_type == 1) {
            var _startX6 = (_start5 - leftLineMinMileage) * everys;
            var endX = (_end5 - leftLineMinMileage) * everys;
            var centerX = (endX + _startX6) / 2; //开始结束平均值
            context.fillRect(centerX + offsetX, axis_LeftLine.y + 15, 2, 15);
            context.moveTo(_startX6 + offsetX, axis_LeftLine.y + 15);
            context.lineTo(endX + offsetX, axis_LeftLine.y + 15);
            context.fillText(desc, centerX + offsetX, axis_LeftLine.y + 35);
          } else if (json[_i8].line_type == 2) {
            var _startX7 = (_start5 - leftLineMinMileage) * everys;
            var _endX2 = (_end5 - leftLineMinMileage) * everys;
            var _centerX2 = (_endX2 + _startX7) / 2;
            ...
            context.moveTo(_startX7 + offsetX, axis_LeftLine_Two.y + 15);
      ...
      function drawAlertAxis(alertListJson) {
        ...
        for (var _i9 = 0; _i9 < json.length; _i9++) {
          var _start6 = parseInt(json[_i9].start_flag) * 1000 + parseInt(json[_i9].start_length);
          var _end6 = parseInt(json[_i9].end_flag) * 1000 + parseInt(json[_i9].end_length);
          context.strokeStyle = "#e53636";
          context.lineWidth = 2;
          context.fillStyle = "#e53636";
          context.font = "12px Microsoft Yahei";
          var desc = "防区 DK" + json[_i9].start_flag + "+" + json[_i9].start_length + "- DK" + json[_i9].end_flag + "+" + json[_i9].end_length;
          context.beginPath();
          if (json[_i9].line_type == 1) {
            var _startX8 = (_start6 - leftLineMinMileage) * everys;
            var endX = (_end6 - leftLineMinMileage) * everys;
            var centerX = (endX + _startX8) / 2; //开始结束平均值
            context.fillRect(centerX + offsetX, axis_LeftLine.y + 10, 2, 20);
            context.moveTo(_startX8 + offsetX, axis_LeftLine.y + 10);
            ...
            var _startX9 = (_start6 - leftLineMinMileage) * everys;
            var _endX3 = (_end6 - leftLineMinMileage) * everys;
            var _centerX3 = (_endX3 + _startX9) / 2;
            context.fillRect(_centerX3 + offsetX, axis_LeftLine_Two.y + 10, 2, 20);
            context.moveTo(_startX9 + offsetX, axis_LeftLine_Two.y + 10);
      ...
      function drawSlopeAxis(slopeListJson) {
        ...
        for (var _i10 = 0; _i10 < json.length; _i10++) {
          var _start7 = parseInt(json[_i10].start_flag) * 1000 + parseInt(json[_i10].start_length);
          var _end7 = parseInt(json[_i10].end_flag) * 1000 + parseInt(json[_i10].end_length);
          var betweenMeters = _end7 - _start7; //两点之间距离米
          var _startX10 = (_start7 - leftLineMinMileage) * everys; //开始值
          var endX = (_end7 - leftLineMinMileage) * everys; //结束值
          var centerX = (endX + _startX10) / 2; //开始结束平均值

          context.lineWidth = 1;
          context.strokeStyle = "#fff";
          context.fillStyle = "#fff";
          context.font = "12px Microsoft Yahei";
          var slope_height = parseFloat(json[_i10].height);
          var slope_length = parseFloat(json[_i10].length);
          ...
          if (json[_i10].line_type == 1) {
            //对角线
            if (json[_i10].type == 1) {
              context.moveTo(_startX10 + offsetX, axis_LeftLine.y + 100); //起点
              context.lineTo(_startX10 + offsetX + betweenMeters * everys, axis_LeftLine.y + 50); //终点
              context.stroke();
              context.fillText(slope_height, _startX10 + offsetX + slope_center - 20, axis_LeftLine.y + 60);
              context.fillText(slope_length, _startX10 + offsetX + slope_center + 20, axis_LeftLine.y + 80);
            }
            if (json[_i10].type == 2) {
              context.moveTo(_startX10 + offsetX, axis_LeftLine.y + 50 + 25); //起点
              context.lineTo(_startX10 + offsetX + betweenMeters * everys, axis_LeftLine.y + 50 + 25); //终点
              context.stroke();
              context.fillText(slope_height, _startX10 + offsetX + slope_center, axis_LeftLine.y + 60);
              context.fillText(slope_length, _startX10 + offsetX + slope_center, axis_LeftLine.y + 80);
            }
            if (json[_i10].type == 3) {
              context.moveTo(_startX10 + offsetX, axis_LeftLine.y + 50); //起点
              context.lineTo(_startX10 + offsetX + betweenMeters * everys, axis_LeftLine.y + 100); //终点
              context.stroke();
              context.fillText(slope_height, _startX10 + offsetX + slope_center + 20, axis_LeftLine.y + 60);
              context.fillText(slope_length, _startX10 + offsetX + slope_center - 20, axis_LeftLine.y + 80);
            }
            //画矩形
            context.strokeRect(_startX10 + offsetX, axis_LeftLine.y + 50, betweenMeters * everys, 50);
          } else if (json[_i10].line_type == 2) {
            //对角线
            if (json[_i10].type == 1) {
              context.moveTo(_startX10 + offsetX, axis_LeftLine_Two.y + 100); //起点
              context.lineTo(_startX10 + offsetX + betweenMeters * everys, axis_LeftLine_Two.y + 50); //终点
              context.stroke();
              context.fillText(slope_height, _startX10 + offsetX + slope_center - 20, axis_LeftLine_Two.y + 60);
              context.fillText(slope_length, _startX10 + offsetX + slope_center + 20, axis_LeftLine_Two.y + 80);
            }
            if (json[_i10].type == 2) {
              context.moveTo(_startX10 + offsetX, axis_LeftLine_Two.y + 50 + 25); //起点
              context.lineTo(_startX10 + offsetX + betweenMeters * everys, axis_LeftLine_Two.y + 50 + 25); //终点
              context.stroke();
              context.fillText(slope_height, _startX10 + offsetX + slope_center, axis_LeftLine_Two.y + 60);
              context.fillText(slope_length, _startX10 + offsetX + slope_center, axis_LeftLine_Two.y + 80);
            }
            if (json[_i10].type == 3) {
              context.moveTo(_startX10 + offsetX, axis_LeftLine_Two.y + 50); //起点
              context.lineTo(_startX10 + offsetX + betweenMeters * everys, axis_LeftLine_Two.y + 100); //终点
              context.stroke();
              context.fillText(slope_height, _startX10 + offsetX + slope_center + 20, axis_LeftLine_Two.y + 60);
              context.fillText(slope_length, _startX10 + offsetX + slope_center - 20, axis_LeftLine_Two.y + 80);
            }
            //画矩形
            context.strokeRect(_startX10 + offsetX, axis_LeftLine_Two.y + 50, betweenMeters * everys, 50);
          }
          context.stroke();
        }
      }
      ...
      function drawProgressAxis(sprogressListJson) {
        ...
        for (var _i11 = 0; _i11 < json.length; _i11++) {
          var _start8 = parseInt(json[_i11].start_flag) * 1000 + parseInt(json[_i11].start_length);
          var _end8 = parseInt(json[_i11].end_flag) * 1000 + parseInt(json[_i11].end_length);
          ...
          if (json[_i11].line_type == 1) {
            var _startX11 = (_start8 - leftLineMinMileage) * everys;
            var endX = (_end8 - leftLineMinMileage) * everys;
            //画水平直线
            context.moveTo(_startX11 + offsetX, axis_LeftLine.y);
            context.lineTo(endX + offsetX, axis_LeftLine.y);
          } else if (json[_i11].line_type == 2) {
            var _startX12 = (_start8 - leftLineMinMileage) * everys;
            var _endX4 = (_end8 - leftLineMinMileage) * everys;
            //画水平直线
            context.moveTo(_startX12 + offsetX, axis_LeftLine_Two.y);
            context.lineTo(_endX4 + offsetX, axis_LeftLine_Two.y);
          } else if (json[_i11].line_type == 3) {
            var _startX13 = (_start8 - enterLineMinMileage) * everys;
            var _endX5 = (_end8 - enterLineMinMileage) * everys;
            if (_start8 == 0) {
              _startX13 = 0;
              _endX5 = _end8 * everys;
            }
            context.moveTo(_startX13 + offsetX, axis_OutLine.y);
            context.lineTo(_endX5 + offsetX, axis_OutLine.y);
          } else if (json[_i11].line_type == 4) {
            var _startX14 = (_start8 - outLineMinMileage) * everys;
            var _endX6 = (_end8 - outLineMinMileage) * everys;
            if (_start8 == 0) {
              _startX14 = 0;
              _endX6 = _end8 * everys;
            }
            context.moveTo(_startX14 + offsetX, axis_OutLine_Two.y);
      ...
      function drawAxesApply(applyListJson) {
        ...
        for (var _i12 = 0; _i12 < json.length; _i12++) {
          var _start9 = parseInt(json[_i12].start_flag) * 1000 + parseInt(json[_i12].start_length);
          var _end9 = parseInt(json[_i12].end_flag) * 1000 + parseInt(json[_i12].end_length);
          //console.log("start：" + start + " end：" + end);
          // 计算当前站点的x轴坐标
          //let startX = (start - parseInt(minkm * 1000)) * everys; //开始值
          // let endX = (end - parseInt(minkm * 1000)) * everys; //结束值

          var descType = json[_i12].type;
          var dksatrt = "DK" + json[_i12].start_flag + " +" + json[_i12].start_length;
          var dkend = "DK" + json[_i12].end_flag + " +" + json[_i12].end_length;

          context.lineWidth = 2;
          if (json[_i12].type == "A1") {
            context.fillStyle = "#f14e0e";
            context.strokeStyle = "#f14e0e";
          } else if (json[_i12].type == "A2") {
            context.fillStyle = "#fd7510";
            context.strokeStyle = "#fd7510";
          } else if (json[_i12].type == "A3") {
            context.fillStyle = "#fda328";
            context.strokeStyle = "#fda328";
          } else if (json[_i12].type == "A4") {
            context.fillStyle = "#f2c136";
            context.strokeStyle = "#f2c136";
          }
          context.beginPath();
          if (json[_i12].line_type == 1) {
            (function () {
        ...
        imgcar.onload = function () {
          ...
          for (var _i13 = 0; _i13 < jsonCar.length; _i13++) {
            ...
            if (jsonCar[_i13].line_type == 1) {
              ...
              //DK
              var codes = jsonCar[_i13].name + "[ ZDK" + jsonCar[_i13].start_flag + " +" + jsonCar[_i13].start_length + " ]";

              context.fillText(codes, startLineX + offsetX + 18, axis_LeftLine.y - 40);
            } else if (jsonCar[_i13].line_type == 2) {
              var _total = parseInt(jsonCar[_i13].start_flag) * 1000 + parseInt(jsonCar[_i13].start_length);
              ...
              //DK
              var _codes2 = jsonCar[_i13].name + " [ YDK" + jsonCar[_i13].start_flag + " +" + jsonCar[_i13].start_length + " ]";
              context.fillText(_codes2, _startLineX + offsetX + 18, axis_LeftLine_Two.y - 40);
            } //
          }
        };
      }
      ...
      function drawAxesPeple(jsonData) {
        ...
        imgcar.onload = function () {
          ...
          context.fillStyle = "#fff ";
          context.font = "12px  Microsoft Yahei";
          for (var _i14 = 0; _i14 < jsonData.length; _i14++) {
            if (jsonData[_i14].line_type == 1) {
              var total = parseInt(jsonData[_i14].start_flag) * 1000 + parseInt(jsonData[_i14].start_length);
              var startLineX = (total - leftLineMinMileage) * everys;
              context.drawImage(imgcar, startLineX + offsetX, axis_LeftLine.y - 40, 36, 36);
              //DK
              var codes = " [" + jsonData[_i14].name + "  ZDK" + jsonData[_i14].start_flag + " +" + jsonData[_i14].start_length + " ]";

              context.fillText(codes, startLineX + offsetX + 20, axis_LeftLine.y - 35);
            } else if (jsonData[_i14].line_type == 2) {
              var _total2 = parseInt(jsonData[_i14].start_flag) * 1000 + parseInt(jsonData[_i14].start_length);
              ...
              //DK
              var _codes3 = " [" + jsonData[_i14].name + "  YDK" + jsonData[_i14].start_flag + " +" + jsonData[_i14].start_length + " ]";
              context.fillText(_codes3, _startLineX2 + offsetX + 20, axis_LeftLine_Two.y - 35);
            } //
          }
        };
      }
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-92e9c040","hasScoped":false,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/views/monitor/index.vue
