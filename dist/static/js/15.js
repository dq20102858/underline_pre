...
// load the styles
var content = __webpack_require__("EJZK");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("fc8fda96", content, true);
  ...
  methods: {
    ...
    getOneChart: function getOneChart(proId, date, proName) {
      ...
      this.request({
        ...
        var data = response.data;
        if (data.status == 1) {
          var jhData = data.data.list[0].data;
          var sjData = data.data.list[1].data;
          var newData = jhData.concat(sjData);
          //console.log(newData);
          ...
          myChart.setOption({
            ...
            tooltip: {
              ...
              formatter: function formatter(params) {
                ...
                showHtm += params[0].marker + params[0].seriesName + "：" + params[0].value + "<br>";
                showHtm += params[1].marker + params[1].seriesName + "：" + params[1].value + "<br>";
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-bc33a3e6","hasScoped":false,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/views/project/chartdata.vue
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"project"}},[_c('div',{staticClass:"el-menu-top"},[_c('el-menu',{attrs:{"router":"","default-active":"chartdata","mode":"horizontal"}},[_c('li',{staticClass:"ptitle"},[_c('img',{attrs:{"src":__webpack_require__("MV+A")}}),_vm._v("工程进度\n      ")]),_vm._v(" "),_c('el-menu-item',{attrs:{"index":"project"}},[_vm._v("作业列表")]),_vm._v(" "),_c('el-menu-item',{attrs:{"index":"schedule"}},[_vm._v("计划日程")]),_vm._v(" "),_c('el-menu-item',{attrs:{"index":"detaillist"}},[_vm._v("详情列表")]),_vm._v(" "),_c('el-menu-item',{attrs:{"index":"chartdata"}},[_vm._v("图表数据")])],1)],1),_vm._v(" "),_c('div',{staticClass:"app-page"},[_c('div',{attrs:{"id":"echart"}},[_c('div',{staticClass:"echart-top"},[_c('el-menu',{staticClass:"el-menu-cus",attrs:{"default-active":_vm.workSelectId.toString()},on:{"select":_vm.changeWorkTypeList}},_vm._l((_vm.workTypeList),function(item){return _c('el-menu-item',{key:item.id,attrs:{"index":item.id.toString()}},[_vm._v(_vm._s(item.name))])}),1),_vm._v(" "),_c('div',{staticClass:"el-serach"},[_c('el-date-picker',{attrs:{"type":"month","placeholder":"在此选择年月查询","format":"yyyy-MM","value-format":"yyyy-MM","editable":false},model:{value:(_vm.echartDate),callback:function ($$v) {_vm.echartDate=$$v},expression:"echartDate"}}),_vm._v(" "),_c('el-button',{on:{"click":_vm.searchChartByDate}},[_vm._v("查询")])],1)],1),_vm._v(" "),_vm._m(0),_vm._v(" "),_c('div',{staticClass:"chart-ontainer"},[_c('el-row',{attrs:{"gutter":20}},[_c('el-col',{attrs:{"span":10}},[_c('div',{staticClass:"second-content"},[_c('h2',[_vm._v(_vm._s(_vm.echartDataNames)+" 总体完成情况")]),_vm._v(" "),_c('ul',{staticClass:"oneitem"},[_c('li',[_c('p',[_vm._v("设计工程量")]),_vm._v(" "),_c('h3',{staticClass:"p1"},[_vm._v("\n                    "+_vm._s(_vm.echartDataList.designTotal)+"\n                    "),_c('em',[_vm._v(_vm._s(_vm.echartDataList.unit))])])]),_vm._v(" "),_c('li',[_c('p',[_vm._v("完成百分比")]),_vm._v(" "),_c('h3',{staticClass:"p2"},[_vm._v(_vm._s(_vm.echartDataList.percent)+"%")])]),_vm._v(" "),_c('li',[_c('p',[_vm._v("剩余工程量")]),_vm._v(" "),_c('h3',{staticClass:"p3"},[_vm._v(_vm._s(_vm.echartDataList.leftTotal)+" "),_c('em',[_vm._v(_vm._s(_vm.echartDataList.unit))])])])]),_vm._v(" "),_c('ul',{staticClass:"twoitem"},[_c('li',[_c('p',[_vm._v("年累完成")]),_vm._v(" "),_c('h3',[_vm._v(_vm._s(_vm.echartDataList.yearTotal)+" "),_c('em',[_vm._v(_vm._s(_vm.echartDataList.unit))])])]),_vm._v(" "),_c('li',[_c('p',[_vm._v("月累完成")]),_vm._v(" "),_c('h3',[_vm._v(_vm._s(_vm.echartDataList.monthTotal)+" "),_c('em',[_vm._v(_vm._s(_vm.echartDataList.unit))])])]),_vm._v(" "),_c('li',[_c('p',[_vm._v("开累完成")]),_vm._v(" "),_c('h3',[_vm._v(_vm._s(_vm.echartDataList.workTotal)+" "),_c('em',[_vm._v(_vm._s(_vm.echartDataList.unit))])])])])])]),_vm._v(" "),_c('el-col',{attrs:{"span":14}},[_c('div',{staticClass:"second-content"},[_c('div',{attrs:{"id":"thirdChart"}})])])],1)],1)])])])}
