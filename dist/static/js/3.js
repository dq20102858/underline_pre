...
// load the styles
var content = __webpack_require__("P9jJ");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("b0bd36f8", content, true);
  ...
  methods: {
    getWorkLists: function getWorkLists() {
      ...
      this.request({
        ...
        if (data.status == 1) {
          ...
          _this2.workPageSize = data.data.per_page;
    ...
    openAddWork: function openAddWork() {
      ...
      this.$nextTick(function () {
        _this3.$refs["workForm"].clearValidate();
      });
    ...
    editWork: function editWork(id) {
      ...
      this.workVisible = true;
      this.$nextTick(function () {
        _this5.$refs["workForm"].clearValidate();
      });
      this.request({
