        ...
        imgcar.onload = function () {
          ...
          for (var _i13 = 0; _i13 < jsonCar.length; _i13++) {
            ...
            if (jsonCar[_i13].line_type == 1) {
              ...
              //DK
              var _codes = jsonCar[_i13].name + " [ YDK" + jsonCar[_i13].start_flag + " +" + jsonCar[_i13].start_length + " ]";
        ...
        imgcar.onload = function () {
          ...
          for (var _i14 = 0; _i14 < jsonData.length; _i14++) {
            if (jsonData[_i14].line_type == 1) {
              ...
              //DK
              var _codes2 = " [" + jsonData[_i14].name + "  YDK" + jsonData[_i14].start_flag + " +" + jsonData[_i14].start_length + " ]";
              context.fillText(_codes2, _startLineX2 + offsetX + 20, axis_LeftLine_Two.y - 35);
            } //
          }
        };
      }
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-7568b970","hasScoped":false,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/views/monitor/index.vue
...
// load the styles
var content = __webpack_require__("BsOk");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("533f97b7", content, true);
