    ...
    getChart: function getChart() {
      ...
      this.request({
        ...
        if (resdata.status == 1) {
          ...
          }, defineProperty_default()(_option, "dataZoom", [{
            type: "slider",
            show: true,
            filterMode: "none",
          ...
          }]), defineProperty_default()(_option, "series", seriesData), _option);
          // 使用刚指定的配置项和数据显示图表。
...
// load the styles
var content = __webpack_require__("4F9u");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("56485154", content, true);
