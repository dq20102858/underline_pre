...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/views/set/speed.vue
//
//
//
//
...
/* harmony default export */ var speed = ({
  data: function data() {
    return {
  ...
  methods: {
    getDataList: function getDataList() {
      ...
      var road_type = 5; //1桥，2隧道，3坡度，4防区，5限速
      this.request({
        ...
        if (data.status == 1) {
          ...
          _this5.lineTypeList.map(function (item, index) {
            if (item.id == data.data.line_type) {
              ...
              _this5.formData.speed = parseFloat(data.data.speed);
            }
          });
        }
      });
...
/* harmony default export */ var views_set_speed = __webpack_exports__["default"] = (Component.exports);
...
// load the styles
var content = __webpack_require__("92py");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("46d71aa1", content, true);
