...
// load the styles
var content = __webpack_require__("q4rD");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("64d450c5", content, true);
      ...
      this.$refs.loginForm.validate(function (valid) {
        if (valid) {
          ...
          _this.$store.dispatch("LoginByUsername", _this.loginForm).then(function () {
            _this.loading = false;
            _this.$router.push({ path: "/monitor" });
          }).catch(function () {
            _this.loading = false;
            return false;
          });
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-56b03a34","hasScoped":false,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/views/login/index.vue
